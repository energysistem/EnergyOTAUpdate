...
public class OTAUpdater extends Activity {
    ...
    private TextView state_update;
    private TextView info_device;
    private TextView desc_updates;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String Correo = prefs.getString("email","pordefecto@gmail.com");

        loading=(ProgressBar)findViewById(R.id.progressBar);
        Buttoncheck=(Button)findViewById(R.id.button);
        state_update=(TextView)findViewById(R.id.state_updates);
        info_device=(TextView)findViewById(R.id.info_device);
        desc_updates=(TextView)findViewById(R.id.desc_update);
        on_off=(Switch)findViewById(R.id.on_offUpdate);
        ButtonDescargar=(Button)findViewById(R.id.download);
        ...
        if (prefs.getBoolean("ota_auto",true)){
            ...
            ButtonDescargar.setVisibility(View.INVISIBLE);
            desc_updates.setVisibility(View.INVISIBLE);
        }
        ...
        on_off.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    //almaceno en los ajustes
                    SharedPreferences.Editor editor= prefs.edit();
                    editor.putBoolean("ota_auto",true);
                    editor.commit();
                    ...
                    //almaceno en los ajustes
                    SharedPreferences.Editor editor= prefs.edit();
                    editor.putBoolean("ota_auto",false);
                    editor.commit();
            ...
            try{
                if (i != null && i.getAction().equals(NOTIF_ACTION)) {
                    if (Utils.dataAvailable(context)) {
                        ...
                        showUpdateInfo(RomInfo.fromIntent(i));
                    } else {
                        checkOnResume = true;
                    }
                } else {
    ...
    private void checkUpdates()
    {
        ...
        new GetInfoFromServer(getApplicationContext(), new GetInfoFromServer.RomInfoListener() {
            ...
            public void onStartLoading() {
                ...
                Buttoncheck.setText(getString(R.string.searching));
                loading.setVisibility(View.VISIBLE);
                state_update.setText(getString(R.string.searching));
            ...
            public void onLoaded(RomInfo info) {
                if (Utils.isUpdate(info)) {
                    ...
                    try
                    {
                        ...
                        Buttoncheck.setText(getString(R.string.search));
                    ...
                    catch (Exception e)
                    {
                        ...
                        loading.setVisibility(View.INVISIBLE);
                        info_device.setVisibility(View.VISIBLE);
                        state_update.setText(getString(R.string.no_updates));
                ...
                //info_device.setText(getString(R.string.new_version) + info.romName + getString(R.string.version) + info.fwversion);
                info_device.setText(getString(R.string.version) + info.fwversion + getString(R.string.new_version) + info.romName);
            }
            @Override
    ...
    private void showUpdateInfo(final RomInfo info)
    {
       //info_device.setText(getString(R.string.new_version) + info.romName + getString(R.string.version) + info.fwversion);

        state_update.setText(getString(R.string.update_found));
        desc_updates.setVisibility(View.VISIBLE);
        desc_updates.setText(info.changelog);
        Buttoncheck.setVisibility(View.INVISIBLE);
        ...
        {
            desc_updates.setText(getString(R.string.changelog) + info.changelog);
